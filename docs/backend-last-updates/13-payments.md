...
**`accountNumber`** (محدّث 2026-09-15): رقم الحساب أو المحفظة كما يُدخل في خانة «رقم الحساب» بلوحة
التحكم. يُرجَع فقط إن كان معبّأً — الحقول الفارغة لا تُرسل. إن لم يظهر لحساب بنك فلسطين، فالخانة
فارغة في اللوحة وتحتاج تعبئة.
